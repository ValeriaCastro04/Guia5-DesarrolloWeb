...
export default function Modal() {
  ...
  const addNotification = useAppStore((state) => state.addNotification); // Obtener addNotification del store
  ...
  const handleFavoriteClick = () => {
    ...
    if (favoriteExists(selectedRecipe.idDrink)) {
      addNotification(`"${selectedRecipe.strDrink}" agregado a favoritos`, 'success');
    } else {
      addNotification(`"${selectedRecipe.strDrink}" eliminado de favoritos`, 'success');
    }
    closeModal();
  };
